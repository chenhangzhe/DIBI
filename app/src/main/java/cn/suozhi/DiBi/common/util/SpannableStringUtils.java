...
public class SpannableStringUtils {
    ...
    public static class Builder {
        ...
        private int defaultValue = ResUtils.getColor(R.color.white);
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(AppContext.appContext, bitmap,ImageSpan.ALIGN_BASELINE), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(AppContext.appContext, uri,ImageSpan.ALIGN_BASELINE), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(AppContext.appContext, resourceId,ImageSpan.ALIGN_BASELINE), start, end, flag);
                    resourceId = 0;
