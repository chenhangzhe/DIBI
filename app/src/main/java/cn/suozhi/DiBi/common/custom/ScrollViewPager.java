...
public class ScrollViewPager extends ViewPager {
     ...
     */
    public ScrollViewPager setAutoScrollDurationFactor(double scrollFactor) {
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<ScrollViewPager> ScrollViewPager;

        public MyHandler(ScrollViewPager ScrollViewPager) {
            this.ScrollViewPager = new WeakReference<ScrollViewPager>(ScrollViewPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    ScrollViewPager pager = this.ScrollViewPager.get();
                    if (pager != null) {
     ...
     */
    public ScrollViewPager setInterval(long interval) {
     ...
     *        {@link #SLIDE_BORDER_MODE_CYCLE}, default is {@link #SLIDE_BORDER_MODE_NONE}
     */
    public ScrollViewPager setSlideBorderMode(int slideBorderMode) {
