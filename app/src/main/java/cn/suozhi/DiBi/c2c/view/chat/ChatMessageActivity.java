 ...
 */
public abstract class ChatMessageActivity extends UI {

    protected String sessionId;

    private SessionCustomization customization;

    private MessageChatFragment messageFragment;

    private SensorManager sensorManager;

    private Sensor proximitySensor;

    protected abstract MessageChatFragment fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        messageFragment = (MessageChatFragment) switchContent(fragment());
        if (enableSensor()) {
            initSensor();
        }
    }
        ...
        for (final SessionCustomization.OptionsButton button : buttons) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    button.onClick(ChatMessageActivity.this, v, sessionId);
                }
            });
    ...
    private SensorEventListener sensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (0.0f == dis[0]) {
                //靠近，设置为听筒模式
                MessageAudioControl.getInstance(ChatMessageActivity.this).setEarPhoneModeEnable(true);
            } else {
                //离开，复原
                MessageAudioControl.getInstance(ChatMessageActivity.this).setEarPhoneModeEnable(UserPreferences.isEarPhoneModeEnable());
            }
        }
