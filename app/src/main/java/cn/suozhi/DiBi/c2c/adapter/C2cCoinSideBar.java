...
public class C2cCoinSideBar extends View {
...
//		"V", "W", "X", "Y", "Z" };
//	/**被选中位置*/
	private List<C2cSliderEnity> list = new ArrayList<>();

	int choose = -1;
	private Paint paint = new Paint();

	public C2cCoinSideBar(Context context) {
		super(context);
	}

	public C2cCoinSideBar(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public C2cCoinSideBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	}


	public void setData(List<C2cSliderEnity> list){
		this.list = list;
		invalidate();
	}
