 ...
 */
public class P2PChatMessageActivity extends ChatMessageActivity {
    private Toolbar  titleToolBar;
    private boolean isResume = false;

    public static void start(Context context, String contactId,String name,SessionCustomization customization, IMMessage anchor) {
        ...
        intent.setClass(context, P2PChatMessageActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     String   name = getIntent().getStringExtra("name");
        titleToolBar = findView(R.id.toolbar_center);
        ToolbarUtil.initToolbar(titleToolBar, sessionId, v -> onBackPressed());
    ...
    protected void showCommandMessage(CustomNotification message) {
        ...
        try {
            ...
            if (id == 1) {
                // 正在输入
                ToastHelper.showToastLong(P2PChatMessageActivity.this, "对方正在输入...");
            } else {
                ToastHelper.showToast(P2PChatMessageActivity.this, "command: " + content);
            }
    ...
    @Override
    protected MessageChatFragment fragment() {
