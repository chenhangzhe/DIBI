...
public class ConsensusExchangeAdapter extends AbsRecyclerAdapter<IeoEntity.DataBean.RecordsBean> {
    ...
    public ConsensusExchangeAdapter(Context context, OnCallbackListener callbackListener) {
        this(context, 0, callbackListener);
    }

    public ConsensusExchangeAdapter(Context context, int height, OnCallbackListener callbackListener) {
