...
import com.netease.nim.uikit.business.session.viewholder.MsgViewHolderNotification;
import com.netease.nim.uikit.business.session.viewholder.MsgViewHolderPicture;
import com.netease.nim.uikit.business.session.viewholder.MsgViewHolderRobot;
...
public class MsgViewHolderFactory {
    ...
    static {
        ...
        register(CustomAttachment.class, MsgViewHolderDefCustom.class);
        register(MyOrderAttachment.class, MsgViewHolderMyOrder.class);
