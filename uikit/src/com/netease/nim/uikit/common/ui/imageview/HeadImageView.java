...
public class HeadImageView extends CircleImageView {
    ...
    public void loadBuddyAvatar(String account) {
        ...
        if (isRecivieMsg) {
            ...
            changeUrlBeforeLoad(TextUtils.isEmpty(UserPreferences.getAvastar(UserPreferences.Avastar)) ? null : UserPreferences.getAvastar(UserPreferences.Avastar), DEFAULT_AVATAR_RES_ID,
                    DEFAULT_AVATAR_THUMB_SIZE);
        }
    ...
    public void loadBuddyAvatar(IMMessage message) {
        isRecivieMsg = message.getDirect() == MsgDirectionEnum.In;
